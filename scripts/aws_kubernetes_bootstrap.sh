...
# PRE-REQUISITES:  AWS CLI and KUBECTL
...
vpc_id="$(aws ec2 describe-vpcs --filters Name=tag:Name,Values=${cluster_name}-vpc --output text --profile ${profile} --region ${region})"
